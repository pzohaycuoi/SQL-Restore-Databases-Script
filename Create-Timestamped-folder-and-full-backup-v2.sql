-- 16/10/2020 Nguyen Hoang Nam
-- Backup databases script vao trong timestamped folder de chay tu dong voi task-scheduler tren primary server
-- Phuc vu cho Dynamic Server: Tu dong khoi phuc databases va tu dong hoi phuc trang thai (chac la nhu vay :v)
...
SET @Path = 'E:\asoft\Backup-Asoft-SQL\'
